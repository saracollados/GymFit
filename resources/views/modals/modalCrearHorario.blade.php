<div class="modal fade" id="modal-crear-horario" tabindex="-1" aria-labelledby="modal-create-content-label" aria-hidden="true">
    <div class="modal-dialog text-xs">
        <div class="modal-content shadow-md">
            <div class="modal-header text-dark-blue uppercase bg-slate-300 font-bold">
                <h5 class="modal-title" id="modal-create-content-label">Crear horario</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{route('crearHorario')}}" method="POST" autocomplete='off'>
                    @csrf
                    ...
                    <div class="flex justify-between mb-6">
                        <div class="w-full">
                            ...
                            <input name="nombre" type="text" id="nombre" class="block w-full p-2 text-gray-900 border border-gray-300 rounded bg-gray-50 outline-1" required>
                        </div>
                    </div>
