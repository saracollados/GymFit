...
@section('header')
  <div class="flex justify-between items-center">
    <h6 class="text-base font-bold text-gray-900">Crear Clase</h6>
  </div>
@endsection
...
@section('content')
    ...
    <form action="{{route('crearClase')}}" method="POST" autocomplete='off'>
        @csrf
        ...
        <div class="flex justify-between mb-6">
            ...
            <div class="w-1/6">
                ...
                <input name="color" type="color" id="color" value="#ffffff" oninput="colorhex.value=value" required>
            </div>
        </div>
        <div class="flex justify-between mb-6">
            <div class="w-full">
                <label for="descripcion" class="block mb-2 text-sm font-medium text-gray-900">Descripcion:</label>
                <textarea name="descripcion" id="descripcion" rows="4" cols="50" class="block w-full p-2 text-gray-900 border border-gray-300 rounded bg-gray-50"></textarea>
            </div>
        </div>
