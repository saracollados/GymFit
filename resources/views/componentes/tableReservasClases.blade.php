<tr class="bg-white">
    ...
    <td class="hidden">{{$item->fecha_id}}</td>
    ...
    <td class="px-6 py-3 text-center">
        ...
        @else
            <a class="py-2 text-sm my-0 mx-0.5 px-3 rounded-lg text-dark-blue reserva-item-list" style="cursor:pointer;" data-id="{{$item->id}}" data-type="clases">
                <i class="fa-solid fa-trash"></i>
            </a>
        @endif
    </td>
